...
<p class="subtitle">
  Accepted: Hellrage JSON Files (from <a
    href="https://github.com/hellrage/NC-Reactor-Planner">Hellrage</a
  >
  or
...
<div class="mb-10 grid-cols-2 gap-10">
  <div class="flex">
    <label
      for="file-data"
      class=" bg-primary/75 font-title mr-auto mb-5 rounded-2xl p-4 font-bold"
  ...
  {#if $rawText}
    <div transition:fade>
      <div
        class="border-primary/50 max-h-[36rem] overflow-y-scroll rounded-lg border-4"
      >
